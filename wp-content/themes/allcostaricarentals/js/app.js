...
function getScrollerWidth() {
  ...
  var inn = null;
  var wNoScroll = 0;
  var wScroll = 0; // Outer scrolling div
  ...
  scr.style.height = '50px'; // Start with no scrollbar

  scr.style.overflow = 'hidden'; // Inner content div

  inn = document.createElement('div');
  inn.style.width = '100%';
  inn.style.height = '200px'; // Put the inner div in the scrolling div

  scr.appendChild(inn); // Append the scrolling div to the doc

  document.body.appendChild(scr); // Width of the inner div sans scrollbar

  wNoScroll = inn.offsetWidth; // Add the scrollbar

  scr.style.overflow = 'auto'; // Width of the inner div width scrollbar

  wScroll = inn.offsetWidth; // Remove the scrolling div from the doc

  document.body.removeChild(document.body.lastChild); // Pixel width of the scroller
...
__webpack_require__(/*! G:\laragon\www\allcostaricarentals\wp-content\themes\allcostaricarentals\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! G:\laragon\www\allcostaricarentals\wp-content\themes\allcostaricarentals\resources\sass\style.scss */"./resources/sass/style.scss");
